...
namespace RobotArm.Common.Patterns.DbContext.DbContextScope
{
    ...
    {
        private Dictionary<Type, System.Data.Entity.DbContext> _initializedDbContexts;
        private Dictionary<System.Data.Entity.DbContext, DbContextTransaction> _transactions; 
        ...
        internal Dictionary<Type, System.Data.Entity.DbContext> InitializedDbContexts { get { return _initializedDbContexts; } }
        ...
        public DbContextCollection(bool readOnly = false, IsolationLevel? isolationLevel = null, IDbContextFactory dbContextFactory = null)
        {
            ...
            _initializedDbContexts = new Dictionary<Type, System.Data.Entity.DbContext>();
            _transactions = new Dictionary<System.Data.Entity.DbContext, DbContextTransaction>();
